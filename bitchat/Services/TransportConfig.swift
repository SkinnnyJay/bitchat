...
enum TransportConfig {
    ...
    static let privateMessagePacketContentMaxBytes: Int = 254
    static let nostrEmbeddedPayloadMaxBytes: Int = privateMessagePacketContentMaxBytes
    ...
    static let messageRouterInboundWiFiPayloadMaxBytes: Int = 64 * 1024
    static let messageRouterInboundWiFiDedupMaxCount: Int = 2_000
